...
const languages = [
  { code: 'hi' as const, name: 'हिंदी', nameEn: 'Hindi' },
  { code: 'en' as const, name: 'English', nameEn: 'English' },
  { code: 'mr' as const, name: 'मराठी', nameEn: 'Marathi' },
];
        ...
        <div className="flex flex-wrap gap-4 justify-center mb-8">
          {languages.map((lang) => (
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className={`
                w-28 h-20 rounded-2xl flex flex-col items-center justify-center transition-all duration-300 relative
                ${language === lang.code
                  ? 'bg-[#F5A623] text-[#1A3C1A] shadow-lg shadow-[#F5A623]/30'
                  : 'bg-[#2D6A2D]/50 border-2 border-[#2D6A2D] text-white hover:border-[#F5A623] hover:bg-[#2D6A2D]'
                }
            ...
            >
              ...
              <span
                className={`text-[20px] font-bold leading-tight ${language === lang.code ? 'text-[#1A3C1A]' : 'text-white'
                  }`}
              >
                {lang.name}
              </span>
              <span
                className={`text-[12px] mt-1 font-medium ${language === lang.code ? 'text-[#1A3C1A]/70' : 'text-[#97BC62]'
                  }`}
              >
                {lang.nameEn}
              </span>
