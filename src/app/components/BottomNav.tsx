...
//     if (isHindi) return item.labelHi;
//     return item.label;
//   };
...
//               }}
//               transition={{ type: 'spring', stiffness: 400, damping: 20 }}
//               className={`w-10 h-10 rounded-2xl flex items-center justify-center transition-colors ${isActive
//                 ? 'bg-[#F5A623]/10'
//                 : 'bg-transparent'
//                 }`}
//             >
//               <Icon
//                 className={`w-5 h-5 transition-colors ${isActive ? 'text-[#F5A623]' : 'text-gray-400'
//                   }`}
//                 strokeWidth={isActive ? 2.5 : 2}
//               />
//             </motion.div>
